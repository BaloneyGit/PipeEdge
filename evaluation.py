...
def evaluation(args):
    ...
    for i in range(5):  
        ...
        print(f"Item {i}: Image size = {image.size()}")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output-dir", type=str, default="/home/tejas/PipeEdge/results/")
    ...
    dset.add_argument("--dataset-name", type=str, default='ImageNet', choices=['CoLA', 'ImageNet'],
                      help="dataset to use")
    dset.add_argument("--dataset-root", type=str, default= "/home/tejas/PipeEdge/",
